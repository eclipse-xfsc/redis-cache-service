...
import (
	...
	openapi "github.com/eclipse-xfsc/redis-cache-service/gen/openapi"
...
func New(
	...
	fileSystemSwagger = appendPrefix(fileSystemSwagger, "/./swagger/")
	return &Server{
		Mounts: []*MountPoint{
			{"Serve ./gen/http/openapi3.json", "GET", "/swagger-ui/openapi.json"},
			{"Serve ./swagger/", "GET", "/swagger-ui"},
		},
...
func Mount(mux goahttp.Muxer, h *Server) {
	MountGenHTTPOpenapi3JSON(mux, http.StripPrefix("/swagger-ui", h.GenHTTPOpenapi3JSON))
	MountSwagger(mux, http.StripPrefix("/swagger-ui", h.Swagger))
}
